defmodule CadetWeb.AchievementsGoalsController do
  ...
  def index_achievements(conn, _) do
    render(conn, "index_achievements.json", achievements: Achievements.get_achievements())
  end

  def index_goals(conn, _) do
    render(conn, "index_goals.json",
      goals: Goals.get_goals_with_progress(conn.assigns.current_user)
    )
  end
